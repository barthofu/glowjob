...
import {ListOffers, RecommendedCompanies} from '../components/modules';
...
const ListJobs = [{
  ...
  "Lieu": "Lyon, France",
  "Niveau": "Senior",
  "Contact": "recrutement@innotech.com"
}, {
  ...
  "Niveau": "Étudiant",
  "Contact": "interns@creativeminds.com"
}];
  ...
  return (
    ...
    >
      ...
      <Box
        ...
        borderRadius="23px"
      >
        {isAlternate ? <RecommendedCompanies/> : <ListOffers />}
          </Box>
          </DefaultLayout>
          );
        }
