...
INSERT INTO "new_Movie" ("backgroundId", "country", "createdAt", "duration", "genre", "id", "popularity", "posterId", "realisatorId", "releaseDate", "synopsis", "title") SELECT "backgroundId", "country", "createdAt", "duration", "genre", "id", "popularity", "posterId", "realisatorId", "releaseDate", "synopsis", "title" FROM "Movie";
DROP TABLE "Movie";
