...
import { createObjectFromPath } from '@cinestia/utils'
import { Paginated } from '@cinestia/contract'
...
export function Table<TData>(props: TableProps<TData>) {
    ...
    const table = useReactTable<TData>({
        ...
        ...(props.pagination ? {
            ...
            pageCount: props.data?.meta.lastPage || 0,
        } : {}),
    ...
    useEffect(() => {
        // disable all row expansion when the page changes
    ...
    return <>
        ...
        {(props.rowSelection?.selectionActionComponent && (table.getIsSomeRowsSelected() || table.getIsAllRowsSelected())) &&
            ...
            // zIndex={1}
            >
                <Box className='Toastify__toast Toastify__toast-theme--white Toastify__toast--success'
                    display='flex'
